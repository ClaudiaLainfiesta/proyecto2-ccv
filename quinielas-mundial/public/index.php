...
try {
    ...
    $partidosPendientesResultado = $stmtPendientes->fetchAll();
    ...
    $stmtProximos = $pdo->prepare($sqlProximos);
    $stmtProximos->execute();
    $proximosPartidos = $stmtProximos->fetchAll();
                    ...
                    <div class="mt-8 flex flex-wrap gap-3">
                      ...
                      hover:scale-[1.02] active:scale-95 transition-all">
                        ...
                        <a href="calendario.php"
                            class="px-5 py-3 rounded-xl bg-white/5 border border-white/10
